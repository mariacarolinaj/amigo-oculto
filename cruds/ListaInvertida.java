...
/*********
 * ARVORE B+ SI String chave1, int chave2
 * 
 * Os nomes dos métodos foram mantidos em inglês apenas para manter a coerência
 * com o resto da disciplina: - boolean create(String chave1, int chave2) -
 * int[] read(String chave1) - boolean delete(String chave1, int chave2)
 * 
 * Implementado pelo Prof. Marcos Kutova v1.0 - 2018
 */

// Árvore B+ para ser usada como índice invertido com repetições
// CHAVE1: String - usado para algum atributo textual da entidade (Nome, Email,
// ...) que pode ser repetido
// CHAVE2: Int - usado para o ID da própria entidade (ou de outra entidade
// qualquer)
...
public class ListaInvertida {
    ...
    public ListaInvertida(int o, String na) throws IOException {
